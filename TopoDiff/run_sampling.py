...
def parse_args():
    ...
    parser.add_argument('--lora', action='store_true', help='Enable LoRA structure before loading a custom checkpoint')
    parser.add_argument('--lora_rank', type=int, default=8, help='LoRA rank used by the checkpoint')
    parser.add_argument('--lora_alpha', type=int, default=16, help='LoRA alpha used by the checkpoint')
    parser.add_argument('--lora_dropout', type=float, default=0.0, help='LoRA dropout for sampling')
    parser.add_argument('--lora_target', type=str, default='backbone', help='Comma-separated module name keywords used during LoRA training')

    # Latent LoRA checkpoint loading
    parser.add_argument('--latent_lora', action='store_true', help='Enable latent LoRA before loading a custom checkpoint')
    parser.add_argument('--latent_lora_rank', type=int, default=4, help='Latent LoRA rank used by the checkpoint')
    parser.add_argument('--latent_lora_alpha', type=int, default=8, help='Latent LoRA alpha used by the checkpoint')
    parser.add_argument('--latent_lora_dropout', type=float, default=0.0, help='Latent LoRA dropout for sampling')
    parser.add_argument('--latent_lora_target', type=str, default='backbone', help='Comma-separated latent module keywords used during LoRA training')
...
def main():
    ...
    sampling_config = {
        ...
        'latent_lora_rank': args.latent_lora_rank,
        'latent_lora_alpha': args.latent_lora_alpha,
        'latent_lora_dropout': args.latent_lora_dropout,
        'latent_lora_target': args.latent_lora_target,
    }
