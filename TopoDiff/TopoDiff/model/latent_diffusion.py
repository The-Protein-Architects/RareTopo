...
logger = logging.getLogger("TopoDiff.model.latent_")


class Latent(nn.Module):

    def __init__(self, config_latent_, depth = 0, log = False):
        super().__init__()

        self.depth = depth
        self.log = log

        self.config = config_latent_
        self.data_config = config_latent_.Data
        self.model_config = config_latent_.Model
